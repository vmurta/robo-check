...
__host__ __device__ void canonicalize_triangle_sep(const int t_v1, const int t_v2, const int t_v2, const float dists_x, const float dists_y, const float dists_z, int *new_t_v1, int *new_t_v2, int *new_t_v3, float *new_dists_x, float *new_dists_y, float *new_dists_z) {
