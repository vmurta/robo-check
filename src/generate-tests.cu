...
int main(){
    ...
    // createAlphaBotConfigurations(hard_confs_ten_thousand, num_confs, true);
    ...
    createAlphaBotConfigurations(hard_confs_hundred_thousand, num_confs, true);
    ...
    // createAlphaBotConfigurations(hard_confs_million, num_confs, true);
